...
- **GOV/205** — VAT charged by the broker on the value of the goods being imported. Often **reclaimable** for VAT-registered businesses (Example Company is — talk to Finance).
